...
<nav id="main_menu">
  <ul>
    <li><a href="board_list_page.do?currentPage=1">자유 게시판</a></li>
  ...
  <section id="notice_free_youtube">
    ...
    <article id="free"> 	<!-- 자유게시판 -->
      <div class="latest_title">
        ...
        <a href="board_list_page.do"><img class="more" src="img/more.gif"></a>
        <div class="clear"></div>					
      </div>
      <div class="latest_content">
        <img class="image" src="img/book_pen.gif">
        <ul class="list">
          ...
          <c:forEach items="${mainlist }" var="list" end="3">
          <li>
            <div class="subject"><a href="read_content_page.do?b_no=${list.b_no }">${list.b_title }</a></div>
            <div class="date">${list.b_writedate }</div>
            <div class="clear"></div>	
